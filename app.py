...
async def main(page: ft.Page):
    ...
    play_button = ft.IconButton(icon=ft.icons.PLAY_ARROW,
                                icon_color=ft.colors.WHITE,
                                on_click=play_pause)
    prev_button = ft.IconButton(icon=ft.icons.SKIP_PREVIOUS,
                                icon_color=ft.colors.WHITE,
                                on_click= lambda _:change_song(-1))
    next_button = ft.IconButton(icon=ft.icons.SKIP_NEXT,
                                icon_color=ft.colors.WHITE,
                                on_click= lambda _:change_song(1))
